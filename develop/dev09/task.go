...
// Unpack обрабатывает строку, где число после буквы означает количество повторений этой буквы.
// Например, "a4bc2d5e" -> "aaaabccddddde".
// Поддерживаются экранированные символы обратной косой чертой (\\).
